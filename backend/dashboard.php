                ...
                <div class="navbar-right">
                    ...
                    <div id="navbar-menu">
                        <ul class="nav navbar-nav">
                            ...
                            <li>
                                <a href="login.php" class="icon-menu"><i class="fa fa-power-off"></i></a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="user-account">
                    ...
                    <div class="dropdown">
                        ...
                        <a href="javascript:void(0);" class="dropdown-toggle user-name"
                            data-toggle="dropdown"><strong><?= $_SESSION['select_name'] ?></strong></a>
                        ...
                        <ul class="right_chat list-unstyled li_animation_delay">
                            <li>
                                <a href="javascript:void(0);" class="media">
                                    ...
                                    <div class="media-body">
                                        <span class="name d-flex justify-content-between">Dr. Chris Fox <i
                            ...
                            <li>
                                <a href="javascript:void(0);" class="media">
                                    ...
                                    <div class="media-body">
                                        <span class="name d-flex justify-content-between">Dr. Joge Lucky <i
                                                class="fa fa-heart-o font-12"></i></span>
                            ...
                            <li>
                                <a href="javascript:void(0);" class="media">
                                    ...
                                    <div class="media-body">
                                        <span class="name d-flex justify-content-between">Dr. Isabella <i
                                                class="fa fa-heart-o font-12"></i></span>
                            ...
                            <li>
                                <a href="javascript:void(0);" class="media">
                                    ...
                                    <div class="media-body">
                                        <span class="name d-flex justify-content-between">Dr. Folisise Chosielie <i
                            ...
                            <li>
                                <a href="javascript:void(0);" class="media">
                                    ...
                                    <div class="media-body">
                                        <span class="name d-flex justify-content-between">Dr. Alexander <i
                                                class="fa fa-heart-o font-12"></i></span>
                        ...
                        <div class="card">
                            ...
                            <div class="body social_counter">
                                <ul class=" list-unstyled basic-list">
                                    <li><i class="fa fa-facebook-square mr-1"></i> FaceBook <span
                                            class="badge badge-primary">16,785</span></li>
                                    <li><i class="fa fa-twitter-square mr-1"></i> Twitter <span
                                            class="badge badge-default">2,365</span></li>
                                    <li><i class="fa fa-linkedin-square mr-1"></i> Linkedin<span
                                            class="badge badge-success">9,021</span></li>
                                    <li><i class="fa fa-google-plus-square mr-1"></i> Google Plus<span
                                            class="badge badge-info">725</span></li>
                                    <li><i class="fa fa-behance-square mr-1"></i> Behance<span
                                            class="badge badge-info">1,725</span></li>
                                    <li><i class="fa fa-dribbble mr-1"></i> Dribbble<span
                                            class="badge badge-info">11,725</span></li>
                                </ul>
                            </div>
                        </div>
                        <div class="card">
                    ...
                    <div class="col-xl-9 col-lg-7 col-md-12">
                        <div class="card">
                            <div class="header">
                                ...
                                <ul class="header-dropdown">
                                    <li><a class="tab_btn" href="javascript:void(0);" data-toggle="tooltip"
                                            data-placement="top" title="Weekly">W</a></li>
                                    <li><a class="tab_btn" href="javascript:void(0);" data-toggle="tooltip"
                                            data-placement="top" title="Monthly">M</a></li>
                                    <li><a class="tab_btn active" href="javascript:void(0);" data-toggle="tooltip"
                                            data-placement="top" title="Yearly">Y</a></li>
                                    <li class="dropdown">
                                        <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown"
                                            role="button" aria-haspopup="true" aria-expanded="false"></a>
                                        <ul class="dropdown-menu dropdown-menu-right">
